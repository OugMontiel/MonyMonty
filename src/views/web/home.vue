<template>
  ...
  <section class="solution.home">
    ...
    <ul>
      ...
      <li>
        <strong>Gestión:</strong> Nos enfocamos en conectar a nuestros usuarios con mentores o expertos financieros capacitados. A través de
        estos expertos, nuestros usuarios pueden aprovechar al máximo nuestro sistema y siempre contarán con asesoramiento financiero
